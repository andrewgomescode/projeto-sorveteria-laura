  ...
  return (
    <>
      <main className={styles.container_principal}>
        <section className={styles.secao_banner_sobre}>
          <div>
            <h1>A GELATERIA</h1>
          </div>
        </section>
        ...
        <section className={styles.secao_imagens}>
          <div>
            <Image className={styles.img} src={image1} alt="pessoas comendo sorvete" />
            <Image className={styles.img} src={image2} alt="loja sorveteria" />
          </div>
        </section>
      </main>
    </>
