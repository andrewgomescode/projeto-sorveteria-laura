  ...
  return (
    <>
      <main>
        ...
        <section className={styles.secao_nossos_sabores}>
          <Image className={styles.img_card} src={image1} alt="sorvetes diversos" />
        ...
        <section className={styles.secao_nossos_eventos}>
          <div className={styles.container_texto}>
          ...
          <Image className={styles.img_card} src={image2} alt="mesa de festa" />
        </section>

        <section className={styles.secao_sobre_nos}>
          <Image className={styles.img_card} src={image3} alt="pessoas comendo sorvete" />
          <div className={styles.container_texto}>
            <h2>SOBRE NÓS</h2>
